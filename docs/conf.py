...
#
# html_title = u'Amazon Kinesis Client Library for Python v1.3.1'
...
htmlhelp_basename = 'AmazonKinesisClientLibraryforPythondoc'
...
man_pages = [
    (master_doc, 'amazonkinesisclientlibraryforpython', u'Amazon Kinesis Client Library for Python Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AmazonKinesisClientLibraryforPython', u'Amazon Kinesis Client Library for Python Documentation',
     author, 'AmazonKinesisClientLibraryforPython', 'One line description of project.',
     'Miscellaneous'),
]
