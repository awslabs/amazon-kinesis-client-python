...
REMOTE_MAVEN_PACKAGES = [
    ...
    ('software.amazon.kinesis', 'amazon-kinesis-client-multilang', '2.3.6'),
    ...
    ('software.amazon.awssdk', 'aws-json-protocol', '2.16.98'),
    ('software.amazon.awssdk', 'dynamodb', '2.16.98'),
    ('software.amazon.awssdk', 'cloudwatch', '2.16.98'),
    ('software.amazon.awssdk', 'netty-nio-client', '2.16.98'),
    ...
    ('software.amazon.awssdk', 'sts', '2.16.98'),
    ('software.amazon.awssdk', 'aws-query-protocol', '2.16.98'),
    ('software.amazon.awssdk', 'protocol-core', '2.16.98'),
    ('software.amazon.awssdk', 'profiles', '2.16.98'),
    ('software.amazon.awssdk', 'sdk-core', '2.16.98'),
    ('com.fasterxml.jackson.core', 'jackson-core', '2.12.4'),
    ('com.fasterxml.jackson.core', 'jackson-databind', '2.12.4'),
    ('software.amazon.awssdk', 'auth', '2.16.98'),
    ('software.amazon.eventstream', 'eventstream', '1.0.1'),
    ('software.amazon.awssdk', 'http-client-spi', '2.16.98'),
    ('software.amazon.awssdk', 'regions', '2.16.98'),
    ('com.fasterxml.jackson.core', 'jackson-annotations', '2.12.4'),
    ('software.amazon.awssdk', 'annotations', '2.16.98'),
    ('software.amazon.awssdk', 'utils', '2.16.98'),
    ('software.amazon.awssdk', 'aws-core', '2.16.98'),
    ('software.amazon.awssdk', 'metrics-spi', '2.16.98'),
    ('software.amazon.awssdk', 'apache-client', '2.16.98'),
