...
""")
    ...
    parser.add_argument("-r", "--regionName", "--region", dest="region", default="us-east-1", metavar="REGION_NAME",
                        help="The region you'd like to make this stream in. Default is 'us-east-1'")
    parser.add_argument("-w", "--word", dest="words", default=[], action="append", metavar="WORD",
                        help="A word to add to the stream. Can be specified multiple times to add multiple words.")
    parser.add_argument("-p", "--period", dest="period", type=int,
                        help="If you'd like to repeatedly put words into the stream, "
                             "this option provides the period for putting words into the stream in SECONDS. "
                             "If no period is given then the words are put once.",
                        metavar="SECONDS",)
